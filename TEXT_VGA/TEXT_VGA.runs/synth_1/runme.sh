...
HD_PWD='C:/Users/Luca Caronti/Google Drive/secondo anno universita/elettronica/VHDL/ProgettoELE3/TEXT_VGA/TEXT_VGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_project.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_project.tcl
