...
HD_PWD='C:/Users/Luca Caronti/Google Drive/secondo anno universita/elettronica/VHDL/ProgettoELE3/TEXT_VGA/TEXT_VGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_project.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_level_project.tcl -notrace
